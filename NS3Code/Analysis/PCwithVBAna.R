...
############################################################################################################################################################################
pktsz1 <- df[df$PktsSize == 1,]
pktsz2 <- df[df$PktsSize == 2,]
pktsz4 <- df[df$PktsSize == 4,]
pktsz8 <- df[df$PktsSize == 8,]
pktsz16 <- df[df$PktsSize == 16,]
pktsz32 <- df[df$PktsSize == 32,]
pktsz64 <- df[df$PktsSize == 64,]
pktsz128 <- df[df$PktsSize == 128,]
pktsz256 <- df[df$PktsSize == 256,]
pktsz512 <- df[df$PktsSize == 512,]
pktsz1024 <- df[df$PktsSize == 1024,]

pktsz1t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz2t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz4t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz8t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz16t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz32t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz64t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz128t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz256t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz512t0 <- pktsz1[pktsz1$BatType == 0,]
pktsz1024t0 <- pktsz1[pktsz1$BatType == 0,]

pktsz1t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz2t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz4t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz8t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz16t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz32t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz64t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz128t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz256t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz512t1 <- pktsz1[pktsz1$BatType == 1,]
pktsz1024t1 <- pktsz1[pktsz1$BatType == 1,]

pktsz1t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz2t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz4t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz8t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz16t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz32t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz64t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz128t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz256t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz512t2 <- pktsz1[pktsz1$BatType == 2,]
pktsz1024t2 <- pktsz1[pktsz1$BatType == 2,]

pktsz1t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz2t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz4t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz8t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz16t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz32t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz64t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz128t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz256t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz512t3 <- pktsz1[pktsz1$BatType == 3,]
pktsz1024t3 <- pktsz1[pktsz1$BatType == 3,]

pktsz1t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz2t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz4t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz8t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz16t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz32t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz64t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz128t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz256t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz512t4 <- pktsz1[pktsz1$BatType == 4,]
pktsz1024t4 <- pktsz1[pktsz1$BatType == 4,]

pktsz1t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz2t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz4t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz8t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz16t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz32t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz64t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz128t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz256t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz512t5 <- pktsz1[pktsz1$BatType == 5,]
pktsz1024t5 <- pktsz1[pktsz1$BatType == 5,]

plot(x = pktsz1$weight, y = pktsz1$DrainTime, type = 'l')